...
def search_bm25_only(
    ...
    Returns:
        ...
        - results: List of search results with BM25 scores and metadata
...
def search_knn_semantic(
    ...
    Returns:
        Dictionary containing:
        - query: The original query
        - results: List of search results with semantic similarity scores and metadata
        - total_count: Number of results
...
def search_radiology_reports_hybrid(
    ...
    Args:
        ...
        top_n_final: Number of final results after re-ranking (default: 10)
        filters: Optional filters for CheXbert labels (e.g., {"Pneumothorax": 1.0})
        rrf_k: RRF rank constant parameter (default: 60, standard default)
